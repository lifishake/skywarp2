...
function sw2_scripts() {
	...
	if ( 'dark' === get_theme_mod( 'colorscheme', 'dark' ) || is_customize_preview() ) {
		wp_enqueue_style( 'twentyseventeen-colors-dark', get_theme_file_uri( '/assets/css/colors-dark.css' ), array( 'sw2-style' ), '1.0' );
	}

	// Load the Internet Explorer 9 specific stylesheet, to fix display issues in the Customizer.
	if ( is_customize_preview() ) {
		wp_enqueue_style( 'twentyseventeen-ie9', get_theme_file_uri( '/assets/css/ie9.css' ), array( 'sw2-style' ), '1.0' );
		wp_style_add_data( 'twentyseventeen-ie9', 'conditional', 'IE 9' );
	}

	// Load the Internet Explorer 8 specific stylesheet.
	wp_enqueue_style( 'twentyseventeen-ie8', get_theme_file_uri( '/assets/css/ie8.css' ), array( 'sw2-style' ), '1.0' );
	...
	if ( has_nav_menu( 'top' ) ) {
		...
		$twentyseventeen_l10n['icon']           = sw2_get_svg( array( 'icon' => 'angle-down', 'fallback' => true ) );
	}
 ...
 */
function sw2_post_thumbnail_sizes_attr( $attr, $attachment, $size ) {
...
add_filter( 'wp_get_attachment_image_attributes', 'sw2_post_thumbnail_sizes_attr', 10, 3 );
