 ...
 */
function skywarp2_nav_menu_social_icons( $item_output, $item, $depth, $args ) {
	// Get supported social icons.
	$social_icons = skywarp2_social_links_icons();
...
add_filter( 'walker_nav_menu_start_el', 'skywarp2_nav_menu_social_icons', 10, 4 );
 ...
 */
function skywarp2_dropdown_icon_to_menu_link( $title, $item, $args, $depth ) {
...
add_filter( 'nav_menu_item_title', 'skywarp2_dropdown_icon_to_menu_link', 10, 4 );
 ...
 */
function skywarp2_social_links_icons() {
	 ...
	 */
	return apply_filters( 'skywarp2_social_links_icons', $social_links_icons );
}
